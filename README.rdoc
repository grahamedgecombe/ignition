...
If you use the default static route and map pages to <tt>/page_name</tt>, then
the route must be added to the end of the routes file, to avoid overriding your
other routes.
...
Ignition will also cache your pages (but not the application layout, in case it
is dynamic).
